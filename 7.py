...
schema = {
    "city": {"type": "string", "description": "The city where the user is located."},
    "industry": {"type": "string", "description": "The most popular industry in the city. What the city is known for."},
    "fun": {"type": "string", "description": "One thing that is fun to do there on a day off"}
}
